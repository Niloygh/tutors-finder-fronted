...
export default function Register() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col bg-slate-50 dark:bg-slate-950 py-12 transition-colors duration-300">
      <div className="grow flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-2xl space-y-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-32 h-32 bg-blue-600/5 dark:bg-blue-600/10 rounded-full -mr-16 -mt-16 blur-3xl"></div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="border-2 border-slate-200 dark:border-slate-700 hover:border-blue-600/50 focus-within:border-blue-600 transition-all duration-300 h-14 bg-white dark:bg-slate-800 w-full rounded-2xl"
                />
              </div>
